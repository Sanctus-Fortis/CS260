...
async function setupDatabase() {
    ...
    try {
        ...
        await db.execute(`
            ...
            ('Dagger', 1, 5, 0, 1, 1),
            ('Shortsword', 1, 7, 0, 1, 1),
            ('Arming Sword', 2, 9, 0, 1, 1),
            ('Longsword', 2, 14, 0, 1, 1),
            ('Greatsword', 2, 18, 0, 1, 1),
            ('Handaxe', 3, 8, 1, 0, 1),
            ('Battleaxe', 3, 12, 0, 1, 1),
            ('Dane Axe', 3, 20, 0, 1, 1),
            ('Club', 4, 8, 0, 1, 1),
            ('Flanged mace', 4, 12, 0, 1, 1),
            ('Morning star', 4, 14, 0, 1, 1),
            ('Warhammer', 4, 16, 0, 1, 1),
            ('Maul', 4, 22, 0, 1, 1),
            ('Javelin', 5, 10, 0, 1, 1),
            ('Shortspear', 5, 12, 0, 1, 1),
            ('Longspear', 5, 17, 0, 1, 1),
            ('Quarterstaff', 6, 16, 0, 1, 1),
            ('Round Shield', 7, 0, 15, 1, 1),
            ('Heater Shield', 7, 0, 12, 1, 1),
            ('Kite Shield', 7, 0, 25, 1, 1),
            ('Shortbow', 8, 10, 0, 1, 1),
            ('Recurve Bow', 8, 15, 0, 1, 1),
            ('Longbow', 9, 18, 0, 1, 1),
            ('Crossbow', 10, 12, 0, 1, 1),
            ('Sling', 11, 8, 0, 1, 1),
            ('Bowgun', 12, 1, 0, 1, 1),
            ('Focus Staff', 13, 0, 0, 1, 1),
            ('Grimoire', 13, 0, 0, 1.1, 1),
            ('Orb', 0, 13, 0, 1, 1.1),
            ('Quartz', 15, 1, 0, 1.1, 1),
            ('Gnarled Branch', 15, 0, 0, 1, 1.1),
            ('Scripture', 14, 0, 0, 1.1, 1),
            ('Holy Symbol', 14, 0, 0, 1, 1.1)
        `);
